...
struct PDFReaderState: ViewModelState {
    struct Changes: OptionSet {
        ...
        static let sidebarEditing = Changes(rawValue: 1 << 5)
        static let sidebarEditingSelection = Changes(rawValue: 1 << 6)
        static let filter = Changes(rawValue: 1 << 7)
        static let activeEraserSize = Changes(rawValue: 1 << 8)
        static let initialDataLoaded = Changes(rawValue: 1 << 9)
        static let visiblePageFromDocument = Changes(rawValue: 1 << 10)
        static let visiblePageFromThumbnailList = Changes(rawValue: 1 << 11)
        static let selectionDeletion = Changes(rawValue: 1 << 12)
        static let activeFontSize = Changes(rawValue: 1 << 13)
        static let library = Changes(rawValue: 1 << 14)
        static let md5 = Changes(rawValue: 1 << 15)
        static let appearance = Changes(rawValue: 1 << 16)
    }
